...
var _excluded = ["show", "renderForShow", "overflowShowTip", "form", "style"];
...
var SInputNumber = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var formatter = useMemo(function () {
    return props.formatter || function (value) {
      return value;
    };
  }, [props.formatter]);
  ...
  var _useMemo = useMemo(function () {
      var flag = !!show;
      var val = value === undefined || value === null ? value : formatter(value);
  ...
  return showFlag ? showValue : /*#__PURE__*/React.createElement(InputNumber, _extends({
    style: _objectSpread({
      width: '100%'
    }, props.style || {})
  }, props, {
